...
final class Schema3 extends i0.VersionedSchema {
  ...
  late final Shape0 preferences = Shape0(
      ...
      alias: null);
  late final Shape1 debug = Shape1(
      source: i0.VersionedTable(
        entityName: 'debug',
        withoutRowId: false,
        isStrict: false,
...
class Shape1 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get id =>
      columnsByName['id']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get hotRestartPage =>
      columnsByName['hot_restart_page']! as i1.GeneratedColumn<String>;
}

i1.GeneratedColumn<String> _column_3(String aliasedName) =>
    i1.GeneratedColumn<String>('hot_restart_page', aliasedName, false,
        type: i1.DriftSqlType.string);
